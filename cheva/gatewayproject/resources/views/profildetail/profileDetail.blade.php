                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-12 ps-lg-5">
                        ...
                        <div class="row sub-detail">
                            ...
                            <a class="nav-link ps-lg-2 pb-2" style="color: #037CF1;" href="profileDetail.html"><i class="bi bi-person-circle" ></i> Profile Details</a>
                            ...
                            <a class="nav-link ps-lg-2 pb-2" href="contact.html"><i class="bi bi-phone" ></i> Contact</a>
                    ...
                    <div class="col-lg-8 col-md-12 col-12">
                        ...
                        <div class="row profile-detail">
                            <div class="col-lg-4 col-md-12 col-12">
                                <div class="card profile-card pb-2" style="width: 335px; height: 163px;">
                                    <div class="card-body">
                                        <h3>About me</h3>
                                        <p class="text-lowercase">Hi, I'm James, a skilled UI/UX designer passionate about creating intuitive and engaging user experiences. Let's collaborate and bring your vision to life!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12 col-12 ps-5">
                                <div class="card profile-card pb-2" style="width: 335px; height: 163px;">
                                    <div class="card-body">
                                        <h3>Name</h3>
                                        <p class="text-lowercase">Shakila Pratama</p>
                                    </div>
                                </div>
                            </div>
                        </div>
